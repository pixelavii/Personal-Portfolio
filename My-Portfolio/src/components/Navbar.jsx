...
import NavGif from '../assets/uchihaEyes.gif';
      ...
      <nav
        className={
          darkMode
            ...
            : "bg-black border-gray-200 z-50 shadow-lg md:px-8 px-1 fixed w-full top-0"
        }
      >
        <div className="flex justify-between items-center py-2 md:py-4 md:px-2 pl-2 mx-auto">
          <div className="flex item-center">
              <img src={NavGif} alt="" style={{ width: '110px'}} className="pl-5"/>
          </div>
